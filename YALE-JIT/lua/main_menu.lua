...
local function exit_main_menu()
	...
	widgets.remove(material_button)
	material_button = nil
end
...
material_button = button{x=display_width*0.5,y=800,text = "Material test",left_click = function(wg) exit_main_menu() return dofile("lua/material_test.lua") end}
